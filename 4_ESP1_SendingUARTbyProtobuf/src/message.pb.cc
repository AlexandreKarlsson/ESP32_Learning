...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_message_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Message, cmdtype_),
  PROTOBUF_FIELD_OFFSET(::Message, msgsize_),
  PROTOBUF_FIELD_OFFSET(::Message, seqnum_),
  PROTOBUF_FIELD_OFFSET(::Message, payload_),
  PROTOBUF_FIELD_OFFSET(::Message, msgend_),
};
...
const char descriptor_table_protodef_message_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  " \001(\r\022\017\n\007msgSize\030\002 \001(\r\022\016\n\006seqNum\030\003 \001(\r\022\017\n"
  "\007payload\030\004 \001(\014\022\016\n\006msgEnd\030\005 \001(\r\",\n\013Comman"
  "dType\022\013\n\007COMMAND\020\000\022\007\n\003ACK\020\001\022\007\n\003REQ\020\002b\006pr"
  "oto3"
  ;
...
constexpr Message_CommandType Message::COMMAND;
constexpr Message_CommandType Message::ACK;
constexpr Message_CommandType Message::REQ;
constexpr Message_CommandType Message::CommandType_MIN;
constexpr Message_CommandType Message::CommandType_MAX;
constexpr int Message::CommandType_ARRAYSIZE;
...
Message::Message(const Message& from)
  ...
  ::memcpy(&cmdtype_, &from.cmdtype_,
    static_cast<size_t>(reinterpret_cast<char*>(&msgend_) -
    reinterpret_cast<char*>(&cmdtype_)) + sizeof(msgend_));
...
void Message::SharedCtor() {
  ...
  ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
      reinterpret_cast<char*>(&cmdtype_) - reinterpret_cast<char*>(this)),
      0, static_cast<size_t>(reinterpret_cast<char*>(&msgend_) -
      reinterpret_cast<char*>(&cmdtype_)) + sizeof(msgend_));
}
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          msgsize_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // uint32 seqNum = 3;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 40)) {
          msgend_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* Message::_InternalSerialize(
  ...
  if (this->cmdtype() != 0) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(1, this->_internal_cmdtype(), target);
  }

  // uint32 msgSize = 2;
  if (this->msgsize() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(2, this->_internal_msgsize(), target);
  }
  ...
  if (this->msgend() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(5, this->_internal_msgend(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:Message)
  ...
  if (from.msgsize() != 0) {
    _internal_set_msgsize(from._internal_msgsize());
  }
  if (from.seqnum() != 0) {
    _internal_set_seqnum(from._internal_seqnum());
  }
  if (from.msgend() != 0) {
    _internal_set_msgend(from._internal_msgend());
  }
}
...
void Message::InternalSwap(Message* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Message, msgend_)
      + sizeof(Message::msgend_)
      - PROTOBUF_FIELD_OFFSET(Message, cmdtype_)>(
          reinterpret_cast<char*>(&cmdtype_),
          reinterpret_cast<char*>(&other->cmdtype_));
}
